...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[0.956124,0.0365877,5.95999e-06,-2.9701e-08,1.24966e-11,4430.61,20.8777], Tmin=(200,'K'), Tmax=(1018.86,'K')), 
            NASAPolynomial(coeffs=[5.84651,0.0360635,-2.07628e-05,5.77497e-09,-6.22585e-13,2464.77,-7.56381], Tmin=(1018.86,'K'), Tmax=(3200,'K')),
        ], 
        Tmin=(200,'K'), 
        Tmax=(3200,'K'),
    ),
